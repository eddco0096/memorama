$(document).ready(function(){var ra = self.location.href; var pb = ra.lastIndexOf("/")+1; var tema = ra.substring(pb,ra.length-5);tema= tema.replace(/%20/g, " ");var x1="CARTAS TERMINADAS \n\n EQUIPO 1"; var element = document.getElementById("imagenes"); 
for (var i = 1; i < 21; i++) {
